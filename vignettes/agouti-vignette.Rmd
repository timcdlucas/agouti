...
Here we have three datasets 1) A dataframe containing the outcome variable and the ID of the polygon that value relates to. 2) A shapefile containing the polygons that are at the resolution of the outcome variable. 3) A raster or raster stack of high-resolution covariates.


```{r}
# three panel plot showing the three datasets
# knitr::kable(head(wnv_cases), digits=2)
# plot(wnv_shp)
# plot(raster_stack[[1]])
```
